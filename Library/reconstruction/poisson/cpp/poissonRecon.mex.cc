...
#pragma omp parallel for
  ...
  std::string arg_depth = std::to_string((long long int)(depth + 0.5));
  std::string arg_full_depth = std::to_string((long long int)(full_depth + 0.5));
  std::string arg_scale = std::to_string((long double)scale);
  std::string arg_samples_per_node =
      std::to_string((long long int)(samples_per_node + 0.5));
  std::string arg_cg_depth = std::to_string((long long int)(cg_depth + 0.5));
