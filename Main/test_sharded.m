function test_sharded(stage,SHARD_NUM,NUM_SHARDS)

setup_shape_reconstruction;

if(any(strcmp(stage,'MATCHING')))
    disp('In stage MATCHING');
    ...
    disp('Completed stage MATCHING');
end

if(any(strcmp(stage,'DEFORMATION')))
...
if(any(strcmp(stage,'RECONSTRUCTION')))
        ...
        if(TEST_RECONSTRUCTION)
            ...
            reconstructed_meshes_TestSubset = cell(3,NUM_SHARDS);
            for i=1:3
                [reconstructed_meshes_TestSubset{i,1}] = ...
                    reconstruct_shape_sharded(deformation_TestSubset{i,1}, ...
                                      voxel_classifier, ...
                                      matches_TestSubset{i,1}, ...
                                      SHARD_NUM, NUM_SHARDS);
            end
            save([path_to_Reconstruction_Sharded '/reconstructed_meshes_TestSubset_' ...
                  num2str(SHARD_NUM) '.mat'],'reconstructed_meshes_TestSubset','-v7.3');
        end
end

if(any(strcmp(stage,'MERGE_RECONSTRUCTION')))
        reconstructed_meshes_TestSubset = ...
            merge_sharded_reconstruction(path_to_Reconstruction_Sharded, ...
                                         NUM_SHARDS);
        save([OutputDir 'reconstructed_meshes_TestSubset'],'reconstructed_meshes_TestSubset','-v7.3');
end

if(any(strcmp(stage,'METRIC_COMPUTATION')))
...
if(any(strcmp(stage,'IMAGE_GENERATION')))
        ...
        if(TEST_IMAGE_GENERATION)
            ...
            for i=1:3
                ...
                generateImage(reconstructed_meshes_TestSubset{i,1}, ...
                              matches_TestSubset{i,1},test_image_dir,TEST_SKIP);
            end
        end
        ...
        if(TEST_VIDEO_GENERATION)
            ...
            for i=1:3
                ...
                generateVideo(reconstructed_meshes_TestSubset{i,1}, ...
                              matches_TestSubset{i,1},test_video_dir,TEST_SKIP);
            end    
        end
end
